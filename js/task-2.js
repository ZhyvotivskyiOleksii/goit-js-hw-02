...
1. Якщо довжина рядка дорівнює або менша за maxLength, то функція повертає початковий рядок без змін.

2. Якщо довжина перевищує maxLength, то функція обрізає рядок до maxLength символів, додає трикрапку "..." в кінці та повертає обрізану версію.

"hello world".slice(0, 5) - [0, 5) - метод який копіює підрядок з індексу початку (0) до індексу кінця не включно (5). 
*/
